 ...
 *
 * @author    Amer Alrdadi
 * @copyright copyrights (c) 2012 - 2013 By Amer Alrdadi
 ...
 */
$_config['project']['url']     = 'http://localhost/cliprz_market';
 ...
 */
$_config['database']['connect']   = TRUE;
$_config['database']['host']      = 'localhost';
$_config['database']['user']      = 'root';
$_config['database']['pass']      = '3011435';
$_config['database']['name']      = 'cliprz_market';
$_config['database']['prefix']    = 'market_';
...
* Templates
*
* @var string $_config['template']['name'] Template Name
*/

$_config['template']['name']      = "default";
