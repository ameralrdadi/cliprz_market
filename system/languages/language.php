...
class cliprz_language
{
    ...
    public function __construct()
    {
        ...
        if(empty($_SESSION['cliprz_language']))
        {
            $name_language = cliprz::system('config')->get('language','name');
        }
        else
        {
            $name_language = $_SESSION['cliprz_language'];
        }

        self::load_language($name_language);
